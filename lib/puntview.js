...
function PuntView(log, p_config, Accessories, plugin_name) {
  ...
  this.port = p_config.puntview.port;
...
PuntView.prototype.refresh = function(index) {
  ...
  if (index == "all") {
    var data = {"label": {"data_type": "accessory", "index": index, "latest": this.latest}, "accessories": []};
    ...
    var data = {"label": {"data_type": "accessory", "index": index, "latest": this.latest}, "accessory": i_data};
  }
