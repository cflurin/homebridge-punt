...
PuntView.prototype.refresh = function(index, t_characteristic) {
...
PuntView.prototype.extract = function(index, t_characteristic) {
  ...
  var i_data = {
    ...
    "type": (this.Accessories[index].i_device.type) ? this.Accessories[index].i_device.type : "simulator",
    "service": (this.Accessories[index].service_name) ? this.Accessories[index].service_name : "",
