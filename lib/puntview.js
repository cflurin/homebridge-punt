...
PuntView.prototype.refresh = function(index, c) {
...
PuntView.prototype.extract = function(index, c) {

  //this.log("PuntView.extract %s %s", index, c);
  if (this.Accessories[index] && this.Accessories[index].i_label[c]) {
    var timestamp = this.Accessories[index].i_label[c].timestamp;
    var trigger = this.Accessories[index].i_label[c].trigger;
