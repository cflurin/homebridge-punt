...
Simulator.prototype.setValue = function(data) {
  ...
  if (value != "undef" && value !=  this.Accessories[index].i_value[t_characteristic]) {
    this.Accessories[index].save_and_setValue(value, t_characteristic, "simulator");
  }
}

Simulator.prototype.get = function(t_characteristic, index, callback, context) {
...
Simulator.prototype.set = function(t_characteristic, index, value, callback, context) {
