...
Gateway.prototype.get_init = function(index, t_characteristic, callback, context) {
...
Gateway.prototype.poll_parsing = function (dataobj) {
  ...
  var context = {
    "initiator": "gateway",
    "accessory": this.name,
    "service": this.i_characteristic.service,
    "characteristic": "undef"
  };
  ...
  switch (expression) {
    ...
    case  ("ContactSensor" + this.name + '-' + reading.ContactSensor.ContactSensorState):
      c = "ContactSensorState"; context.characteristic = c;
      ...
      this.i_characteristic.ContactSensorState.setValue(r_value, null, context);
      break;
    ...
    case ("Lightbulb" + this.name + '-' + reading.Lightbulb.Hue):
      ...
      this.i_characteristic.Hue.setValue(this.i_value.Hue, null, contex);
      c = "Saturation"; context.characteristic = c;
      this.i_characteristic.Saturation.setValue(this.i_value.Saturation, null, contex);
    ...
    case ("TemperatureSensor" + this.name + '-' + reading.TemperatureSensor.CurrentTemperature):
      c = "CurrentTemperature"; context.characteristic = c;
      r_value = parseFloat(dataobj[1].match(/[+-]?\d*\.?\d+/));
      this.i_value.CurrentTemperature = r_value;
      this.i_characteristic.CurrentTemperature.setValue(r_value, null, context);
      break;
              
    case ("WindowCovering" + this.name + '-' + reading.WindowCovering.CurrentPosition):
      c = "CurrentPosition"; context.characteristic = c;
      ...
      if(r_value != this.i_value.CurrentPosition) {
        ...
        this.i_characteristic.CurrentPosition.setValue(r_value, null, context);
      }
      c = "TargetPosition"; context.characteristic = c;      
      if(r_value != this.i_value.TargetPosition) {
        ...
        this.i_characteristic.TargetPosition.setValue(r_value, null, context);
      }
      break;
      
    case ("WindowCovering" + this.name + '-' + reading.WindowCovering.CurrentHorizontalTiltAngle):
      c = "CurrentHorizontalTiltAngle"; context.characteristic = c;
      r_value = parseInt(dataobj[1]);
      ...
      if(r_value != this.i_value.CurrentHorizontalTiltAngle) {
        ...
        this.i_characteristic.CurrentHorizontalTiltAngle.setValue(r_value, null, context);
      }
      c = "TargetHorizontalTiltAngle"; context.characteristic = c;
      ...
      if(r_value != this.i_value.TargetHorizontalTiltAngle) {
        ...
        this.i_characteristic.TargetHorizontalTiltAngle.setValue(r_value, null, context);
      }
      break;
