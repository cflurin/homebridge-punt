...
function Gateway(log, p_config, Charactereistic, props) {
  ...
  this.save_and_setValue = props.save_and_setValue;
  ...
  switch (expression) {
    ...
    case  ("Switch" + this.name):
      ...
      if(r_value != this.i_value[c]) { 
        ...
        this.save_and_setValue(r_value, c, "fhem");
      }
      break;
    ...
    case ("Lightbulb" + this.name + '-' + reading.Lightbulb.Brightness):
      ...
      if(r_value != this.i_value[c]) {
        this.i_characteristic[c].setValue(r_value); // todo context
    ...
    case ("Lightbulb" + this.name + '-' + reading.Lightbulb.Hue):
      ...
      this.i_characteristic[c].setValue(this.i_value[c]); // todo context
