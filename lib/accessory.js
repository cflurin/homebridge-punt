...
Accessory.prototype.predifined_service = function(Service) {
  ...
  //this.log("Test %s", this.service.displayName);
  ...
  switch (this.service_name) {
    ...
    case "ContactSensor":
      ...
      this.i_value[c] = this.Characteristic[c].CONTACT_DETECTED;
      break;
    ...
    case "Lightbulb":
      ...
      */
      ...
      c = "Brightness";
      this.service
        .addCharacteristic(this.Characteristic[c])
    ...
    case "WindowCovering":
      ...
      */
      ...
      this.i_value[c] = this.Characteristic[c].STOPPED;
      
      // Optional Characteristics
      var operationmode = this.config_accessory.operationmode || "roller";
...
Accessory.prototype.characteristic_change = function(objValue) {
  ...
  //this.log("Accessory.c_change %s %s %s %s", this.index, this.name, c, value);
